...
class DatabasePageLayout:
    def __init__(self) -> None:
        ...
        self.confirm_delete_game_modal = ConfirmModal('delete-game', title = 'Delete Game?', children = [],
                                                      confirm_button_color = 'danger')
        self.confirm_continue_game_modal = ConfirmModal('continue-game', title = 'Continue Game?', children = [])
