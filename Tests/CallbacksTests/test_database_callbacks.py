...
class DatabaseCallbacksTest(CallbacksBaseTests):
    ...
    def test_load_games(self) -> None:
        ...
        self.dependency_mock.games_repository.list_games.return_value = ['1711631564.271273', '1711652784.985871',
                                                                         '1711652844.830463']
        self.dependency_mock.games_repository.list_versions.return_value = ['1711716794.867666', '1711716802.085491',
                                                                            '1711716803.288263', '1711716810.73072',
                                                                            '1711716811.613999',
                                                                            '1711716833.329125']
        ...
        self.assertTrue(len(response[0]) == 3)
        self.assertTrue(all(isinstance(r, dbc.Card) for r in response[0]))
    ...
    def test_open_delete_game_modal(self) -> None:
        ...
        callback_class.get_prop_from_context.return_value = {'index': '1711733259.033643',
                                                             'type': 'game-entry-delete-button'}
        callback_class.operations = Mock()
        callback_class.operations.format_game_ts_pretty.return_value = '18:27 - 29.Mar.2024'
    ...
    def test_delete_game(self) -> None:
        ...
        callback_class.games_repository.delete_game.assert_called_once_with('1711733259.033643')
    ...
    def test_continue_game(self) -> None:
        ...
        callback_class = ContinueGameModal(self.dependency_mock)
        callback_class.get_prop_from_context = Mock()
        callback_class.get_prop_from_context.return_value = 'continue-game-confirm-button'

        callback_class.games_repository = Mock()
        callback_class.games_repository.list_versions.return_value = ['1711716794.867666', '1711716802.085491',
                                                                      '1711716803.288263', '1711716810.73072',
                                                                      '1711716811.613999',
                                                                      '1711716833.329125']
        callback_class.games_repository.load.return_value = Game(ts = 1711733259.033643, version = 1711716833.329125)
        ...
        self.assertIsNone(response[1])
        self.assertIsNone(response[2])
        callback_class.games_repository.load.assert_called_once_with('1711733259.033643', '1711716833.329125')
