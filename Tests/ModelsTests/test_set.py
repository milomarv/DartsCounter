...
class SetTests(ModelsBaseTests):
    ...
    def test_get_avg_score(self, player_name: str, actual_avg: int) -> None:
        ...
        avg_player = set_instance.get_avg_score(game_simulation.players[player_name])
    ...
    def test_score_count(self, attribute: str, player: str, desired_val: int, counted_val: int) -> None:
        ...
        # Act
        score_count = set_instance.get_score_count(attribute, desired_val, player_instance)
    ...
    def test_get_possible_and_successful_checkouts(self, player_name: str, actual_possible_checkouts: int,
        ...
        # Act
        possible_checkouts, successful_checkouts = set_instance.get_possible_and_successful_checkouts(player)
